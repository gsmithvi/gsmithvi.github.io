...
Retain only GBIF observations contained within the country level polygon, using `sp::over()`. I did this because GBIF observations do not always contain accurate stateProvince information. Also, I'm reading in Uruguay roads as shapefiles. 

```r
# create SpatialPoints object of monk parakeet observations
lon <- mp$decimalLongitude
lat <- mp$decimalLatitude
...
<img src="/images/uruguay-pop.tiff" width="500" height ="500" />
...
<img src="/images/uruguay-landcover.tiff" width="500" height ="500" />


### Create a trellis map object, with land cover layer now scaled by population numbers
...
### Add other layers to the trellis object p: country border, roads and GBIF sightings
...
<img src="/images/mymon-uruguay-landcover.png" width="600" height ="600" />
